...
@Component({
  ...
  styleUrls: ["pie-preview-layout.scss"],
})
export class PiePreviewLayout {
  ...
  componentDidLoad() {
    ...
    this.tabElement.addEventListener(
      "MDCTabBar:activated",
      this.handleActivated.bind(this)
    );
    this.designElement.addEventListener(
      ModelUpdatedEvent.TYPE,
      this.handleModelUpdated.bind(this)
    );
  }
  ...
  render() {
    return (
      <div class="author-preview-container">
        {/* tab bar */}
        <div
          ref={(el) => (this.tabElement = el as HTMLDivElement)}
          class="mdc-tab-bar author-preview-tab-bar"
          role="tablist"
        >
        ...
        <div class="author-preview-tab-contents">
          <div ref={(el) => (this.designElement = el as HTMLDivElement)}>
            <slot name="configure" />
          </div>
          ...
          >
            ...
            <div class="pie-player">
              <pie-player
                loader={this.loader}
                ref={(el) =>
                  (this.piePlayerElement = el as HTMLPiePlayerElement)
                }
                disableBundler={true}
