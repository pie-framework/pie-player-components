...
import { BundleEndpoints } from "./pie-loader";
...
declare global {
    ...
    interface HTMLItemPreviewToolElement extends Components.ItemPreviewTool, HTMLStencilElement {
    }
    var HTMLItemPreviewToolElement: {
        prototype: HTMLItemPreviewToolElement;
        new (): HTMLItemPreviewToolElement;
    };
    ...
    interface HTMLElementTagNameMap {
        ...
        "item-preview-tool": HTMLItemPreviewToolElement;
...
declare namespace LocalJSX {
    interface CodeEditor {
        "onEnter"?: (event: CustomEvent<void>) => void;
        "onUpdated"?: (event: CustomEvent<string>) => void;
        "text"?: string;
    }
    interface ItemPreviewTool {
        "text"?: string;
    ...
    interface IntrinsicElements {
        ...
        "item-preview-tool": ItemPreviewTool;
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            ...
            "item-preview-tool": LocalJSX.ItemPreviewTool & JSXBase.HTMLAttributes<HTMLItemPreviewToolElement>;
