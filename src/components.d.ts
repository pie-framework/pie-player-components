...
import { BundleEndpoints, LoaderConfig } from "./pie-loader";
import { Env, ItemConfig, ItemSession, PieContent, PieController, PieElement, PieModel } from "./interface";
import { ExternalImageSupport } from "./components/pie-author/dataurl-image-support";
import { ExternalUploadSoundSupport } from "./components/pie-author/dataurl-upload-sound-support";
export { BundleEndpoints, LoaderConfig } from "./pie-loader";
export { Env, ItemConfig, ItemSession, PieContent, PieController, PieElement, PieModel } from "./interface";
export { ExternalImageSupport } from "./components/pie-author/dataurl-image-support";
export { ExternalUploadSoundSupport } from "./components/pie-author/dataurl-upload-sound-support";
...
export interface PieAuthorCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLPieAuthorElement;
}
export interface PiePlayerCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLPiePlayerElement;
}
export interface PiePreviewControlCustomEvent<T> extends CustomEvent<T> {
    detail: T;
...
declare namespace LocalJSX {
    ...
    interface PieAuthor {
         ...
         */
        "onModelLoaded"?: (event: PieAuthorCustomEvent<any>) => void;
        /**
    ...
    interface PiePlayer {
         ...
         */
        "onLoad-complete"?: (event: PiePlayerCustomEvent<any>) => void;
        /**
         ...
         */
        "onPlayer-error"?: (event: PiePlayerCustomEvent<any>) => void;
        /**
         ...
         */
        "onResponseCompleted"?: (event: PiePlayerCustomEvent<any>) => void;
        /**
         ...
         */
        "onSession-changed"?: (event: PiePlayerCustomEvent<any>) => void;
        /**
          * Optional CSS class for the stimulus container wrapper
         */
        "passageContainerClass"?: string;
    ...
    interface PiePreviewControl {
        "onEnvChanged"?: (event: PiePreviewControlCustomEvent<any>) => void;
    }
    interface PiePreviewLayout {
        "config"?: Object;
    }
